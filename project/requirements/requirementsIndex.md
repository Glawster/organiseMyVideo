...
| 028 | [Camera history reconciliation](features/028-cameraHistoryReconciliation.md) | Verify import history against the current archive and reconcile moved files without losing original destination evidence. | ToDo | [Prompt](prompt/028-cameraHistoryReconciliation.md) | [ADR-003](../adr/003-filesystemSafetyBoundary.md), [ADR-006](../adr/006-cameraImportArchitecture.md), [ADR-008](../adr/008-sqliteMediaCatalogue.md) |
...
>>>>>>> c747932 (Implement mixed SLR card import for REQ-026.)
